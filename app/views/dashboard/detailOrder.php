<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        <div class="col-md-8 card p-3 m-3">
            ...
            <?php if ($data['detailOrder']['status'] == 'ordered') : ?>
                <form action="<?= BASEURL; ?>dashboard/prosesOrder" class="my-3" method="post">
                    <input type="hidden" name="id" id="" value="<?= $data['detailOrder']['id']; ?>">
                    <input type="text" class="form-control mb-2" name="resi" placeholder="Resi Pengiriman">
